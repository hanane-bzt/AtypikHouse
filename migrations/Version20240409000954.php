 ...
 */
final class Version20240409000954 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE habitat CHANGE file file VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE habitat CHANGE file file VARCHAR(255) NOT NULL');
    }
}

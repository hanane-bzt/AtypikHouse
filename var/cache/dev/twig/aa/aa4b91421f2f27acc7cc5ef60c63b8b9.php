...
class __TwigTemplate_cf1acb3325a8f35f271e25c6e1bbf2d6 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(("Modifier la catégorie : " . CoreExtension::getAttribute($this->env, $this->source, (isset($context["category"]) || array_key_exists("category", $context) ? $context["category"] : (function () { throw new RuntimeError('Variable "category" does not exist.', 3, $this->source); })()), "name", [], "any", false, false, false, 3)), "html", null, true);
...
{% block title \"Modifier la catégorie : \" ~ category.name  %}
...
{% block body %}
 ...
 {% endblock %}
 ", "admin/category/edit.html.twig", "/home/benou/framework-symfony/Sites/Lab/AtypikHouse/templates/admin/category/edit.html.twig");
    }
}

...
class __TwigTemplate_1f9ffcd6fa02927c8bdbd405ea721c17 extends Template
{
    private $source;
    private $macros = [];
...
<html>
    <head>
        ...
        <link rel=\"icon\" href=\"data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 128 128%22><text y=%221.2em%22 
        font-size=%2296%22>⚫️</text><text y=%221.3em%22 x=%220.2em%22 font-size=%2276%22 fill=%22%23fff%22>sf</text></svg>\">
    ...
    <body>
                 ...
                 <div class=\"collapse navbar-collapse\">
                     ...
                     <ul class=\"navbar-nav\">
                         ...
                         <li class=\"nav-item\">
                             <a class=\"nav-link ";
        // line 31
        if ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 31, $this->source); })()), "request", [], "any", false, false, false, 31), "attributes", [], "any", false, false, false, 31), "get", ["_route"], "method", false, false, false, 31) == "admin.habitat.index")) {
            yield "active";
        }
        yield "\" href=\"";
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin.habitat.index");
        yield "\">Habitats</a>
                         ...
                         <li class=\"nav-item\">
                          <a class=\"nav-link ";
        // line 34
        if ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 34, $this->source); })()), "request", [], "any", false, false, false, 34), "attributes", [], "any", false, false, false, 34), "get", ["_route"], "method", false, false, false, 34) == "admin.category.index")) {
            yield "active";
        }
        yield "\" href=\"";
    ...
    <body>
        <nav class=\"navbar bg-primary navbar-expand-lg\" data-bs-theme=\"dark\">
            ...
            <div class=\"container-fluid\">
                 ...
                 <a class=\"navbar-brand\" href=\"{{ path('admin.habitat.index') }}\">Administration</a>
                 ...
                 <div class=\"collapse navbar-collapse\">
                     ...
                     <ul class=\"navbar-nav\">
                         ...
                         <li class=\"nav-item\">
                             <a class=\"nav-link {% if app.request.attributes.get('_route') == 'admin.habitat.index' %}active{% endif %}\" href=\"{{ path('admin.habitat.index') }}\">Habitats</a>
                         </li>
                         <li class=\"nav-item\">
...
", "admin/admin.html.twig", "/home/benou/framework-symfony/Sites/Lab/AtypikHouse/templates/admin/admin.html.twig");
    }
}

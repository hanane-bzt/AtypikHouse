...
class __TwigTemplate_ce076fd3f5c7579d0c024946d291da24 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div>
        ...
        yield "</div>
            <div class=\"col-sm\">";
        // line 12
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 12, $this->source); })()), "service", [], "any", false, false, false, 12), 'row');
        yield "</div>
...
";
    ...
    {
        return array (  113 => 15,  107 => 12,  103 => 11,  99 => 10,  94 => 8,  90 => 6,  80 => 5,  60 => 3,  37 => 1,);
    }
...
{% endblock %}
", "contact/contact.html.twig", "/home/benou/framework-symfony/Sites/Lab/AtypikHouse/templates/contact/contact.html.twig");
    }
}

 ...
 */
class getVichUploader_Listener_Clean_HabitatsService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.clean.habitats' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.clean.habitats'])) {
            return $container->privates['vich_uploader.listener.clean.habitats'];
        }

        return $container->privates['vich_uploader.listener.clean.habitats'] = new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('habitats', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? self::getVichUploader_MetadataReaderService($container)), $a);
    }
}
